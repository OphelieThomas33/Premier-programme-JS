...
// Afficher la nouvelle citation et son auteur : 
function genererCitation() {

	do {
		nombreAleatoire   = entierAleatoire(citations.length);
...
// Détecter le clic de l'utilisateur et demander la nouvelle citation : 
nouvelleCitation.addEventListener('click', genererCitation);
